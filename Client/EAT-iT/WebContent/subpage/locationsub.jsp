...
<body>
   ...
   function fadeo() {
	...
	<nav>
		<div class="nav-rec">
			<div class="nav-text">
				<h1 class="location" align="center">서울 지역별 맛집 TOP</h1>
		...
		<div class="repeat">
			<form action="Mutual_allinfo_add">
				<select name="location" onChange="window.open(value,'_self');"
					class="sel1">
					<option value="Mutual_allinfo_add.do?address=강남">선택</option>
					<option value="Mutual_allinfo_add.do?address=강남">강남</option>
					<option value="Mutual_allinfo_add.do?address=종로">종로</option>
					<option value="Mutual_allinfo_add.do?address=서대문구">서대문구</option>
					<option value="Mutual_allinfo_add.do?address=중구">중구</option>
					<option value="Mutual_allinfo_add.do?address=마포">마포</option>
					<option value="Mutual_allinfo_add.do?address=송파">송파</option>
					<option value="Mutual_allinfo_add.do?address=용산">용산</option>
					<option value="Mutual_allinfo_add.do?address=서초">서초</option>
					<option value="Mutual_allinfo_add.do?address=동작">동작</option>
					<option value="Mutual_allinfo_add.do?address=성동">성동</option>
					<option value="Mutual_allinfo_add.do?address=동대문">동대문</option>
					<option value="Mutual_allinfo_add.do?address=성북">성북</option>
					<option value="Mutual_allinfo_add.do?address=관악">관악</option>
				</select>
			</form>
			<form action="#">
