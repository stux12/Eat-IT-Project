...
<body>
	...
	<section>
		...
		<form action="ClientUpdate.do" method="post">
			<table>
				<tr>
					<td colspan="2" style="text-align: center;"><h3>회원 정보 수정</h3></td>
				</tr>
				<tr>
					<td>아이디</td>
			...
			<div class="button">
				<input type="submit" value="수정" style="width: 100px; border-radius: 15px"/>
				<input type="reset"  value="취소" style="width: 100px; border-radius: 15px"/>
				<input type="hidden" value="이름" name="irum2" />
			</div>	
		</form>
	</section>
