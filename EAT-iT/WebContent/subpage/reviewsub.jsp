...
<body>
   ...
   function fadeo() {
	...
	<nav>
		<div class="nav-rec">
			<div class="nav-text">
				<h1 class="location" align="center">리뷰순별 맛집 TOP</h1><br><br>
				<p class="location-sub" align="center">리뷰가 많이달린 맛집은 뭐가있을까?</p>
			</div>
		</div>
	</nav>
	...
	<section class="sect1">
		<div class="repeat">
			<form action="#">
				<c:forEach var="vo4" items="${alist3}">
					<table>
						<tr>
							<td rowspan=5><a href="detail.do?mutual=${vo4.mutual}"><img src="${vo4.firstimg}"
								style="width: 300px; height: 250px; padding: 35px;"></a></td>
							<td class="sangho">상호명: ${vo4.mutual}</td>

						</tr>
						<tr>
							<td>리뷰 수: ${vo4.count}</td>
						</tr>
						<tr>
							<td class="juso">주소: ${vo4.address}</td>
						</tr>
						<tr>
							<td>소개: ${vo4.introduce}</td>
						</tr>
						<tr>

							<td><input type="hidden" value='${vo4.mutual}'
								name="mutual1"></td>
							<td><input type="button" value="찜" class="button1"
								onclick="Button1_Click('${vo4.mutual}');" /></td>
